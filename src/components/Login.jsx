        ...
        >
          ...
          <div className="space-y-1 text-sm mt-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-md"
            />
            <div className="flex justify-end text-xs text-white my-2">
              <a rel="noopener noreferrer" href="#">
                Forgot Password?
              </a>
            </div>
          </div>
          <button className="block w-full p-3 text-center rounded-sm text-white bg-yellow-400">
            Sign in
          </button>
        </form>
        <div className="flex items-center my-4 space-x-1">
          <div className="flex-1 h-px w-16 "></div>
